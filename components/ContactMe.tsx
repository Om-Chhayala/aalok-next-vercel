...
export default function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:aaloklowanshi@gmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name}.${formData.message}`;
  };
      ...
      >
        ...
        <div className="space-y-1 md:space-y-3 lg:space-y-3 xl:space-y-3 2xl:space-y-5">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-lg md:text-2xl lg:text-2xl">+91 9399414458</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#f7ab0a] h-7 w-7 animate-pulse" />
            <p className="text-lg md:text-2xl lg:text-2xl">
              aaloklowanshi@gmail.com
            </p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
