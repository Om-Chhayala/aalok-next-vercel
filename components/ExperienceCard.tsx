...
export default function ExperienceCard({ experience }: Props) {
  return (
    <article className=" flex drop-shadow-xl flex-col rounded-3xl items-center space-y-0 flex-shrink-0 w-72  md:w-[600px] xl:w-[700px] xl:h-[440px] xl:mt-33 snap-center bg-white p-5 md:p10 hover:opacity-100 opacity-100 cursor-pointer transition-opacity duration-200 "
    ...
    >
      ...
      <div className="w-full px-0 md:px-10">
        <div className=" md:flex md:justify-between items-center">
          <div>
            <h4 className="text-lg md:text-3xl font-light text-black mb-2">
              {experience?.jobTitle}
            </h4>
            <p className="font-bold text-md md:text-2xl  mt-1 text-black">
              {experience?.company}
            </p>
        ...
        <p className="uppercase py-1 md:py-2 text-black text-sm md:text-lg">
